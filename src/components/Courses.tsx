          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-8">
            {packages.map((pkg, index) => {
              ...
              return (
                <div 
                  key={index}
                  className={`relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 transform-gpu ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} ${pkg.popular ? 'ring-2 ring-[#741b1c]' : ''}`}
                  style={{ transitionDelay: `${index * 100}ms` }}
                >
                  {pkg.popular && (
                  ...
                  <div className="p-8">
                    ...
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600 mt-3 text-sm leading-relaxed min-h-[48px]">{pkg.description}</p>
                    </div>

                    {/* Features */}
                    <div className="space-y-3 mb-8 min-h-[176px]">
